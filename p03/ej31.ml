...
let e2=
(function lg2 -> (function log2 -> log2(float (1024 * 1024))) function x -> log x /. lg 2) log 2.;;
...
(function sqr -> (function pi -> function r -> pi *. sqr r) 2. *. asin 1.)) x *. x
...
let saluda s = (function true -> printendline "Hola!" | false -> ()) s = "Hola"

(*let f n = if n mod 2 = 0 then "es par" else "es impar";;*)
let f n = (function true -> "es par" | false "es impar") n mod 2 = 0;;


(*let f n = if n mod 2 = 0 then "multiplo de 2"*)
(*else if n mod 3 = 0 then "multiplo de 3"*)
(*else "impar";;*)

let f n = (function true -> print_endline"multiplo de 2" | 
false ((function true -> print_endline"multtiplo de 3"| false -> print_endline"impar")n mod 3 = 0)) n mod 2 = 0;;
